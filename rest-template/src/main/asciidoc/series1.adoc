...
HTTP connections. You can switch to use different HTTP library like Apache HttpComponents, Netty, OkHttp though the
...
==== OPTIONS
[source,java,indent=0]
include::{examples-dir}/com/yetanotherdevblog/RestTemplateTest.java[tags=OPTIONS]

==== PATCH
[source,java,indent=0]
include::{examples-dir}/com/yetanotherdevblog/RestTemplateTest.java[tags=PATCH]
...
We saw very basic stuff about RestTemplate. In next series I am gonna dive into more fine-grained details
of how to customize RestTemplate behaviour like
